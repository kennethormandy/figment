...
describe('.figure--square', function () {
  ...
  before(function(done) {
    ...
    new Nightmare()
      ...
      .goto('http://localhost:' + port + '/test/fixtures/figure--square')
      .screenshot(path.join('./test/fixtures/screenshots', 'figure--square--1024x768.png'))
      .run()

    new Nightmare()
      .viewport(640, 480) // Classic!
      .goto('http://localhost:' + port + '/test/fixtures/figure--square')
      .screenshot(path.join('./test/fixtures/screenshots', 'figure--square--640x480.png'))
      .run(done)
  })

  it('Should match reference at 640×480 viewport', function (done) {

    var fileName = 'figure--square--640x480.png'
  ...
  it('Should match reference at 1024×768 viewport', function (done) {
    ...
    var fileName = 'figure--square--1024x768.png'
    var pathBase = './test/fixtures/'
    var pathRef = pathBase + '/reference/'
    var pathTest = pathBase + '/screenshots/'
    var pathFail = pathBase + '/failed/'
